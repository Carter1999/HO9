...
{
                alert("Sorry, please pnly enter a number 100 or less");
                $("total_fib").value = "";
}
else
{
...
while (intCount>2)
{
    ...
    j=k;// sets the new j = to the current k. i and ju must be set in this order in the loop
    intCount--; //decremnts the intCount counter variable
}
$("output").value = stringOutput; //prints the solution
};
